...
import (
	...
	baremetalHTTPBasic "github.com/nexclipper/gophercloud/openstack/baremetal/httpbasic"
	baremetalNoAuth "github.com/nexclipper/gophercloud/openstack/baremetal/noauth"
	blockstorageNoAuth "github.com/nexclipper/gophercloud/openstack/blockstorage/noauth"
)
...
func AcceptanceTestChoicesFromEnv() (*AcceptanceTestChoices, error) {
	...
	/* // Temporarily disabled, see https://github.com/nexclipper/gophercloud/issues/1345
	if networkID == "" {
